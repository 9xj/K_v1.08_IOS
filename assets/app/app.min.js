...
var s_fileextension = 'html',
	s_appversion = '1.08',
	s_expectedsettingsversion = ((new Date('2015-08-31')) > (new Date()) ? '1.01' : '1.03'),
	s_db = undefined,
	s_url = '',
...
$('#attendancemarking').live('pagebeforeshow',function(event, data){
	subscribetoselectionchangedevent(function(){
		// need to get the date and calendar day are synced up before continuing
		changeDateAndRunFuction(g_selecteddate, function(){
			loadStudentAttendanceForPeriod(g_loginkey, g_loggedinteacher.teachercode, g_selecteddate, g_selectedperiod, g_selectedcalendarday.weekoftimetable, '', false);
		});
	});
